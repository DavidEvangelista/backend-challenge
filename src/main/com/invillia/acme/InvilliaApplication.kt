...
import com.invillia.acme.config.ApplicationProperties
import com.invillia.acme.config.addDefaultProfile
...
class InvilliaApplication(private val env: Environment) : InitializingBean {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes backendchallenge.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<InvilliaApplication>(*args) { addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(InvilliaApplication::class.java)
